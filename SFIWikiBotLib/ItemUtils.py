...
itemDisplayStatSwitcher = {
    ...
    'ship': (lambda obj, p: GetNameOfShipAssociatedWithItem(obj) or ''),
...
itemStatDescriptionSwitcher = {
    ...
    'ship': (lambda s, pt: "The ship this item is associated with.  Items unique to a ship cannot be used with any other ship."),
