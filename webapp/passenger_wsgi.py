...
def GetFilterListForItemFinder(params):
    ...
    filterList.append({
        ...
        'type': 'string',
        'input': 'select',
        'values':  ["None", "Absorbing Stealth","Anti Stealth","Ben's Blessing","Ben's Curse","Blinded","Cold Fusion Damage","Concussion","Corrosion","Curse","Damage Bubble","Dark Bubble","Dephase","Disruption","Drift","Effect Dampen","Effect Nourish","Electrostatic Bubble","Energy Drain","Energy Recharge","Engine Overdrive","Escape Teleport","Fast Shield Repair","Fire Suppression","Frozen","Gravity Field","Hallucination","Hard Light Decay","Hard Light Saw","Harden","Heat Damage","Hellfire","Hidden by Smoke","Highlighted","Holographic Disguise","Inverse Gravity Field","Invulnerable","Light Bending Stealth","Locking Jammed","Magnetic Disruption","Mine Magnet","Photonic Damage","Power Failure","Propulsion Dehance","Radiation Damage","Recharging Blocked","Red Mist Haze","Red Mist Horn Circle","Red Mist Horns","Red Mist Overdose","Reflecting Bubble","Reflecting Stealth","Resonance","Scanner Jammed","Selective Effect Dampen","Sheenite Locking Boost","Shield Bubble","Shield Repair","Slow Down","Solarion Sight","Stabiliser Fail","Targetting Enhance","Teleport Jammed","Transparent Stealth","Vendetta Bonus","Weapon Attract","Weapon Repel"],
        'operators': [ 'equal', 'not_equal' ],
    })
    filterList.append({
